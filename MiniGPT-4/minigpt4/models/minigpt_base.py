...
class MiniGPTBase(BaseModel):
    ...
    def prompt_wrap(self, img_embeds, atts_img, prompts, lengths=None):
        if prompts is None or len(prompts) == 0:
            ...
            # print(f"VIT EMBEDDING LENGTH: {emb_lens}")
    ...
    def preparing_embedding(self, samples):
        ...
        if 'conv_q' in samples:
            ...
            self.prompt_list =  ["Provide a detailed description of the surroundings.",
                                "Explain the layout of the area.",
                                "Describe the key features of the environment.",
                                "What obstacles or potential hazards are present?",
                                "Identify any notable landmarks or points of interest.",
                                "Describe the surface and terrain of the area.",
                                "Describe the scene.",
                                "Can I cross the street?",
                                "Describe any signage or visual markers.",
                                "Provide information about the scene.",
                                "Are there any cars nearby?",
                                "Describe the surroundings.",
                                "What is the level of activity or movement in the scene?",
                                "Identify the presence of any vehicles or transportation.",
                                "What is the general layout of the streets or pathways?",
                                "Provide a summary of the overall spatial configuration."]
            self.prompt_list = [f"<Img><ImageHere></Img> {i}" for i in self.prompt_list]
            ...
            instruction = [random.choice(self.prompt_list)]
            # instruction = ["<Img><ImageHere></Img> Describe the scene"]
