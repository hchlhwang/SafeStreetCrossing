...
class RunnerBase:
    ...
    def train(self):
        ...
        for cur_epoch in range(self.start_epoch, self.max_epoch):
            ...
            print(f"current epoch is: {cur_epoch}")
            # evaluation phase
                    ...
                    if val_log is not None:
                        if is_main_process():
                            ...
                            if agg_metrics > best_agg_metric and split_name == "val":
                                ...
                                counter = 0
                                print(f"First if statement counter: {counter}")
                            else:
                                counter += 1
                                print(f"Elif statement counter: {counter}")

                            if counter >= patience:
                                logging.info(f"Early stopping triggered. Best Epoch: {best_epoch}")
                                print(f"Break statement counter: {counter}; patience: {patience}")
                                break
            ...
            if self.evaluate_only or counter >= patience:
                break
